...
public class FruitResourceIntegrationTest extends JerseyTest {
    ...
    public void givenCreateFruit_whenFormContainsNullParam_thenResponseCodeIsBadRequest() {
        ...
        Response response = target("fruit/create").request(MediaType.APPLICATION_FORM_URLENCODED).post(Entity.form(form));
    ...
    public void givenCreateFruit_whenJsonIsCorrect_thenResponseCodeIsCreated() {
        ...
        assertThat(response.readEntity(String.class), containsString("Fruit saved : Fruit(weight=20, name=strawberry, colour=null, serial=null)"));
    }
    ...
    public void givenUpdateFruit_whenFormContainsBadSerialParam_thenResponseCodeIsBadRequest() {
        ...
        Response response = target("fruit/update").request(MediaType.APPLICATION_FORM_URLENCODED).put(Entity.form(form));
    ...
    public void givenCreateFruit_whenFruitIsInvalid_thenResponseCodeIsBadRequest() {
        ...
        Response response = target("fruit/create").request(MediaType.APPLICATION_JSON_TYPE).post(Entity.entity(fruit, MediaType.APPLICATION_JSON_TYPE));
